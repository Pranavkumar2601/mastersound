...
// // List all products with category & subcategory names
...
//     `SELECT
//        id, name, description, price, quantity, category_id, subcategory_id, created_at
//      FROM products
//      WHERE id = ?`,
//     [id]
//   );
...
// // Insert serial numbers; expects uppercase, validated beforehand
